		...
		<main className="space-y-6">
				...
				<div className="grid grid-cols-3 gap-6 px-6 py-8 sm:items-center sm:px-10 sm:py-10">
					<div className="relative col-span-1 -mx-6 h-27.5 sm:mx-0 sm:h-auto">
						...
						<Image
							...
							width={260}
							height={260}
							className="absolute top-5 -left-4 size-40 select-none object-cover sm:size-52.5 sm:-translate-y-1/2"
						/>
					</div>

					<div className="relative z-10 col-span-2">
						<h1 className="bg-linear-to-r from-background to-tertiary-100 bg-clip-text font-bold text-[24px] text-transparent leading-tight sm:text-[30px]">
			...
			{isPremium && (
				<div className="w-full rounded-[10px] border border-green-200 bg-[#EDFCF4] p-4 text-fourtiary-400">
					<p className="font-bold text-xl sm:text-2xl">Anda sudah berlangganan!</p>
