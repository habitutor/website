  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] gap-0 overflow-hidden p-0 sm:max-w-114">
        <div className="p-6">
          <DialogHeader>
            <DialogTitle className="text-left text-xl font-bold">{steps[step - 1].title}</DialogTitle>
          ...
          <div className="flex flex-col items-start gap-4 pt-6">
            ...
            <p className="text-left text-sm leading-relaxed text-muted-foreground">{steps[step - 1].description}</p>
          </div>
        </div>
