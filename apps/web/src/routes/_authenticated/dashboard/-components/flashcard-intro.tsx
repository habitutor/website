  ...
  return (
    <div className="relative flex min-h-[70vh] w-full items-center justify-center">
      ...
      <m.div
        ...
        style={{ zIndex: 1 }}
      >
        <div className="h-[280px] w-[92vw] rounded-[10px] border-[3px] border-solid border-[#e1a902] bg-[#fdc10e] shadow-[0px_2px_2px_0px_rgba(54,80,162,0.2)] sm:h-[380px] sm:w-[700px] sm:border-[5px] lg:h-[466px] lg:w-[900px]" />
      </m.div>
      ...
      <m.div
        ...
        style={{ zIndex: 2 }}
      >
        <div className="h-[290px] w-[92vw] rounded-[10px] border-[3px] border-solid border-[#e1a902] bg-[#fdc10e] shadow-[0px_2px_2px_0px_rgba(54,80,162,0.2)] sm:h-[390px] sm:w-[700px] sm:border-[5px] lg:h-[477px] lg:w-[900px]" />
      </m.div>
      ...
      <m.div
        ...
        className="relative w-[92vw] overflow-hidden rounded-[10px] border-2 border-solid border-[#d2d2d2] bg-white shadow-[0px_2px_2px_0px_rgba(54,80,162,0.2)] sm:h-[390px] sm:w-[700px] sm:border-4 lg:h-[477px] lg:w-[900px]"
        style={{ zIndex: 10 }}
      >
        ...
        <div className="flex h-full w-full flex-col sm:hidden">
          ...
          <div className="relative mx-4 mt-4 h-[44px] shrink-0 overflow-clip rounded-[5px] border border-green-700 bg-green-500">
            ...
            <p className="absolute top-1/2 left-[16px] -translate-y-1/2 text-[16px] font-bold tracking-widest whitespace-nowrap text-white">
              00:10:00
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 px-4 pt-3 pb-6">
            <p className="text-[36px] leading-tight font-bold text-[#fdc10e]">Mari Mulai!</p>
            <p className="text-[13px] leading-snug font-medium text-[#333]">
        ...
        <div className="hidden h-full w-full sm:block">
          ...
          <div className="absolute overflow-clip rounded-[5px] border border-green-700 bg-green-500 sm:top-[30px] sm:left-[32px] sm:h-[60px] sm:w-[calc(100%-64px)] lg:top-[44px] lg:left-[48px] lg:h-[76px] lg:w-[calc(100%-96px)]">
            ...
            <p className="absolute top-1/2 -translate-y-1/2 font-bold tracking-widest whitespace-nowrap text-white sm:left-[20px] sm:text-[22px] lg:left-[25px] lg:text-[27px]">
              00:10:00
            </p>
          </div>

          {/* Mari Mulai text */}
          <p className="absolute leading-tight font-bold text-[#fdc10e] sm:top-[110px] sm:left-[32px] sm:w-[45%] sm:text-[54px] lg:top-[147px] lg:left-[47px] lg:text-[75px]">
            Mari Mulai!
          </p>

          {/* Description text */}
          <p className="absolute leading-snug font-medium text-[#333] sm:top-[200px] sm:left-[32px] sm:w-[45%] sm:text-[15px] lg:top-[259px] lg:left-[47px] lg:text-[20px]">
            Kamu punya sepuluh menit untuk mengerjakan semua soal
          </p>
