...
export const Route = createFileRoute("/_authenticated/admin/classes/$shortName/$contentId")({
		...
		<>
			<div className="w-fit">
				...
				{content.isPending ? (
					...
					<h1 className="font-bold text-2xl text-red-500">Error: {content.error.message}</h1>
				) : (
