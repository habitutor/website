		...
		<section className="overflow-x-hidden bg-background py-16">
			<div className="container mx-auto flex w-full max-w-4xl flex-col gap-20 px-4">
				...
				<div className="relative">
					<MotionPulse>
						<motion.div
							className="absolute -bottom-90 md:-bottom-100 -left-30 z-0 size-40 rounded-full bg-tertiary-100 md:size-46"
							initial={{ opacity: 0 }}
							whileInView={{ opacity: 1 }}
							viewport={{ once: true }}
					...
					<div className="absolute -right-6 -bottom-8 z-0 hidden md:block md:-right-36 md:-bottom-2">
						<Image
