...
export function Hero() {
	...
	return (
		<section className="relative mx-auto flex w-full flex-col items-center justify-start overflow-hidden rounded-b-[40px] border-2 border-tertiary-200 border-t-0 bg-background px-4 pt-22 pb-10 shadow-[0_2px_2px_0_rgba(54,80,162,0.20)] md:pb-35">
			...
			<div className="container z-1 flex shrink-0 flex-col space-y-10 pt-8 md:mx-auto md:space-y-13 md:pt-20">
				<div className="flex max-w-3xl flex-col items-start gap-1 text-left md:gap-2">
					<span className="rounded-full border-2 border-neutral-300 bg-neutral-100 px-3 py-2 font-medium text-primary-600 text-xs md:text-sm">
					...
					<motion.h2
						...
						className="font-bold font-sans text-3xl leading-10 sm:text-4xl md:text-5xl md:leading-18"
					>
