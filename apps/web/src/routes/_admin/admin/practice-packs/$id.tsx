        ...
        <div className="flex-1 lg:order-1">
          <Card className="rounded-xl shadow-sm">
            ...
            <CardContent className="space-y-4 p-4 pt-0 sm:p-6 sm:pt-0">
              <div>
                <h4 className="mb-2 font-semibold text-base sm:text-lg">
                  Question:
                </h4>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will remove the question from this practice pack. The
              question will still exist in the question bank.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
