  ...
  return (
    <section className="relative overflow-hidden bg-background">
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <MotionPulse>
          <div className="absolute right-10 top-70 w-15 h-15 rounded-full bg-[#C5F5DC] border-2 border-green-100" />
        </MotionPulse>

        <MotionPulse>
          <div className="absolute left-10 top-80 w-15 h-15 rounded-full bg-secondary-100 border-2 border-secondary-200" />
        </MotionPulse>
      </div>
      ...
      <div className="relative overflow-hidden w-screen h-30 md:h-40 xl:h-50 pointer-events-none">
        <div className="absolute inset-0 inset-y-0 bg-tertiary-100 xl:[clip-path:polygon(25%_100%,75%_100%,100%_0,100%_100%,0_100%,0_0)] 2xl:[clip-path:polygon(35%_100%,65%_100%,100%_0,100%_100%,0_100%,0_0)] md:[clip-path:polygon(20%_100%,80%_100%,100%_0,100%_100%,0_100%,0_0)] [clip-path:polygon(30%_100%,70%_100%,100%_30%,100%_100%,0_100%,0_30%)] z-2" />
        <div className="absolute rounded-t-full w-130 h-75 md:w-230 md:h-115 bg-red-100 border-2 border-red-200 left-1/2 -translate-x-1/2" />
        <div className="flex flex-col items-center justify-end pb-5 md:pb-10 h-full z-10 relative">
          <p className="text-lg md:text-2xl font-bold text-center">Ultimate Bundling & Privilege</p>
          <p className="text-sm md:text-lg text-center md:max-w-none max-w-50">Paket yang paling worth it, Paling lengkap dan murah!!</p>
        </div>
      </div>
