export const DATA = {
  ...
  basic: {
    privilege1: {
      ...
      cta: {
        ...
        url: "https://lynk.id/habitutor/391r3l9y5wd9",
      },
    },
    privilege2: {
      label: "Privilege 02",
      ...
      cta: {
        label: "Mulai Sekarang",
        url: "http://lynk.id/habitutor/ojdjk1nrodyx",
      },
    },
  },
  ...
  perintis: {
    perintis1: {
      ...
      cta: {
        label: "Mulai Sekarang",
        url: "https://lynk.id/habitutor/z19qjzqr0ln9",
      },
    },
    ...
    perintis2: {
      ...
      cta: {
        label: "Mulai Sekarang",
        url: "https://lynk.id/habitutor/6ypyrrqr8ggl",
      },
    },
  },
