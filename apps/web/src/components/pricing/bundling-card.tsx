	...
	if (isPremium) {
		...
		return (
			...
			>
				...
				<div className="relative z-10 border-2 border-primary-400 border-b-0 px-6 py-4">
					...
					<div className="flex items-baseline gap-1">
						<p className="font-black text-3xl text-[#FEEAAE]">{data.price_now}</p>
				...
				<div className={cn("relative z-10 flex-1 border-primary-400 border-x-2 px-6 pb-4", premiumColors.bg)}>
				...
				<div className="relative z-10 border-2 border-primary-400 border-t-0 p-6">
					<Link
