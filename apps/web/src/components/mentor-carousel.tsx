		...
		return (
			<div className="relative h-full w-full overflow-hidden rounded-2xl border-2 border-primary-100 bg-white p-5 shadow-md">
				<div className="z-10 text-left">
					<div className="border-primary-100 border-b-2 pb-2">
						<h3 className="font-bold text-base">{item.name}</h3>
						<p className="inline-block whitespace-nowrap text-sm">{item.major}</p>
						<p className="text-sm">{item.university}</p>
					</div>
					<div className="space-y-0.5 pt-2 font-italic text-sm">
