    ...
    >
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex items-start gap-3">
          ...
          <p className="font-medium text-sm sm:text-base lg:text-lg text-neutral-1000 mr-7">
            {item.title}
          </p>
        </div>
          ...
          ({ key, label, icon: Icon, enabled, className, width }) =>
            enabled(item) && (
              <Link
                ...
                params={params}
                className={cn(
                  "flex items-center gap-1.5 sm:gap-2 rounded-[5px] px-2.5 sm:px-4 py-1.5 sm:py-2.5 transition-opacity hover:opacity-90",
                  "w-full sm:w-auto",
                  className,
                  width,
                )}
              >
                ...
                <span className="whitespace-nowrap font-medium text-xs sm:text-[14px]">
                  {label}
                </span>
                <CaretRightIcon
                  className="size-4 sm:size-[18px] ml-auto"
                  weight="bold"
                />
              </Link>
            ),
  ...
  return (
    <Card className="rounded-[10px] border border-neutral-200 p-4 sm:p-5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex items-center gap-2 sm:flex-col sm:items-end">
          {shortName && (
            <span className="text-muted-foreground text-xs">{shortName}</span>
          )}
        </div>
      </div>
