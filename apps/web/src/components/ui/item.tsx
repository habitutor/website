...
function ItemGroup({ className, ...props }: React.ComponentProps<"ol">) {
  return <ol data-slot="item-group" className={cn("group/item-group flex flex-col", className)} {...props} />;
}
  ...
  "flex shrink-0 items-center justify-center gap-2 group-has-[[data-slot=item-description]]/item:translate-y-0.5 group-has-[[data-slot=item-description]]/item:self-start [&_svg]:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        destructive:
          "size-8 rounded-sm border border-destructive/20 bg-destructive/10 [&_svg:not([class*='size-'])]:size-4",
      },
    },
    defaultVariants: {
      variant: "default",
