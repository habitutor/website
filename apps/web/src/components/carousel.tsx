          ...
          {items.map((item, index) => {
            ...
            return (
              <button
                ...
                disabled={isTransitioning}
                className={`size-2 rounded-full transition-all duration-200 disabled:cursor-not-allowed ${index === activeIndex ? "scale-125 bg-dot-active" : "scale-125 bg-dot-inactive"
                  }`}
              />
            );
          })}
