/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 203af7c681a5bd768e223172e1263194)
// Runtime types generated with workerd@1.20251109.0 2025-06-15 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		NODE_ENV: "production";
		CORS_ORIGIN: "http://localhost:3000" | "https://habitutor.ithabitutor.workers.dev";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CORS_ORIGIN" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
